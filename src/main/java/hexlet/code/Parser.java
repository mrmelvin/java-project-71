...
public class Parser {
     ...
     * @param firstData Путь до первого файла
     * @param secondData Путь до второго файла
     ...
     * @throws IOException
     */
    public static Map<String, Object[]> parse(Map firstData, Map secondData) throws IOException {
